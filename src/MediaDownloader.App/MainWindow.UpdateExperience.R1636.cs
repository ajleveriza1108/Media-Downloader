...
{
    private void UpdateNoticeR1636_IsVisibleChanged(object sender, DependencyPropertyChangedEventArgs e)
    {
        ...
        UpdateNoticeTransformR1636.BeginAnimation(
            System.Windows.Media.TranslateTransform.YProperty,
            null);

        UpdateNoticeR1620.Opacity = 0;
        UpdateNoticeTransformR1636.Y = -10;
    ...
    private void UpdateNoticeDismissR1636_Click(object sender, RoutedEventArgs e)
    {
        var fade = new DoubleAnimation(UpdateNoticeR1620.Opacity, 0, TimeSpan.FromMilliseconds(140))
        {
            EasingFunction = new QuadraticEase { EasingMode = EasingMode.EaseIn }
        };
        var slide = new DoubleAnimation(UpdateNoticeTransformR1636.Y, -7, TimeSpan.FromMilliseconds(150))
        {
            EasingFunction = new QuadraticEase { EasingMode = EasingMode.EaseIn },
        ...
        fade.Completed += (_, _) =>
        {
            ...
            UpdateNoticeTransformR1636.Y = 0;
