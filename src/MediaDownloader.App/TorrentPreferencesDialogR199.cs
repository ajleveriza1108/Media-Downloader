...
public sealed class TorrentPreferencesDialogR199 : Window
{
    ...
    private UIElement BuildGeneral()
    {
        ...
        _remember.ToolTip = "MediaDock R1.6.59 keeps loaded torrents until you explicitly remove them.";
    ...
    private UIElement BuildConnection()
    {
        ...
        AddNote(panel, "R1.6.59 always binds an automatic local peer port so trackers receive a valid port and outbound connections work immediately. This toggle only enables router mapping/inbound reachability. Windows may show a one-time firewall permission prompt for TorrentHost.");
        return panel;
    }
